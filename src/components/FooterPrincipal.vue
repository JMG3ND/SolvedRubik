		...
		* {
		...
		&__item {
			...
			&:hover {
				...
				.fa-facebook,
				.social-networks-list__text--facebook {
					color: #077ae9;
				}

				.fa-twitter,
				.social-networks-list__text--twitter {
					color: #1c99e6;
				}

				.fa-instagram,
				.social-networks-list__text--instagram {
					color: #c30073;
				}

				.fa-youtube,
				.social-networks-list__text--youtube {
					color: #f10002;
				}

				.fa-whatsapp,
				.social-networks-list__text--whatsapp {
					color: #1acc3e;
				}
			}
